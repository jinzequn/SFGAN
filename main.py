...
def Encoder(Inputs, is_train=True, reuse=None):
    ...
    with tf.variable_scope("G", reuse=reuse) as vs:
        ...
        net_c64 = tl.layers.conv2d(net_bn2, 64, (3, 3), (1, 1), act=tf.nn.relu, padding='SAME', W_init=w_init,
        ...
        net_c256 = tl.layers.conv2d(net_bn4, 256, (3, 3), (1, 1), act=tf.nn.relu, padding='SAME', W_init=w_init,
                                    B_init=b_init, name='g_5c')
        net_bn5 = tl.layers.BatchNormLayer(net_c256, act=tf.identity, gamma_init=g_init, name='g_bn5')
        net_c512 = tl.layers.conv2d(net_bn5, 512, (3, 3), (1, 1), act=tf.nn.relu, padding='SAME', W_init=w_init,
                                    B_init=b_init, name='g_6c')
        net_bn6 = tl.layers.BatchNormLayer(net_c512, act=tf.identity, gamma_init=g_init, name='g_bn5')
        net_c512 = tl.layers.conv2d(net_bn6, 512, (3, 3), (1, 1), act=tf.nn.relu, padding='SAMW', W_init=w_init,
